Feature: Quick Navigation
	...
	Scenario: US OP-398 TC_007 QUICK NAVIGATION Adding Deadline Using Date Picker
		...
		And the user selects date "09/15/2021 12:30 pm" by using the date picker
		Then the date "09/15/2021 12:30 pm" should appear on the date box	
	...
	#[https://qa.openlycrm.com|https://qa.openlycrm.com/]
	@OP-421 @OP-422
	Scenario: US OP-398 TC_008 QUICK NAVIGATION Adding Time Planning by Using Date Picker
		Given the user is logged in as "Human Resource"
		When the user clicks on "Task" tab on the quick navigation
		And the user clicks on Time Planning link
		And the user clicks on Start Task on date box
		And the user selects date "08/24/2021 09:00 am" by using the date picker
		Then the date "08/24/2021 09:00 am" should appear on the start task on date box
		When the user clicks on Finish date box
		And the user selects date "09/13/2021 07:00 pm" by using the date picker
		Then the date "09/13/2021 07:00 pm" should appear on the Finish date box