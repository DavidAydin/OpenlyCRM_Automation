...
public class ActivityStreamTaskStepDefs {
    ...
    @When("the user hovers over the following checklist item and clicks on the delete icon")
    public void the_user_hovers_over_the_checklist_item_and_clicks_on_the_delete_icon(String checkListItem) {
        ActivityStreamTaskPage activityStreamTaskPage = new ActivityStreamTaskPage();
        activityStreamTaskPage.clickDeleteButtonOf(checkListItem);
